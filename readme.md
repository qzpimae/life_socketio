...
guests are welcomed to use their phone to connect a site which has a "plant seeds" button. alternitivley they can press a numpad-keyboard covered in moss, and they are encourged to "touch grass"
...
There was no real "thesis" or "message" or "point" i was trying to explicity get across. the theme of 'plant-education' was perfectly suited for the work i was already doing. 
up to this point, all the visuals i coded were in some way aimed at trying to simulate the infinite beauty of nature with the compute power i could harness with coding. 
I simply aimed to create an intriging, fun, ideally meditative space. to use what i know, explore what i love, and learn as much as i could with the unique opportunity i was given.
...
its quite commonn that by happenstance, cells will fall into alignment with one another and keep eachother alive. in fact its almost an imposible chance that all the cells would cancel out to dead. 
...
even now, i dont aim to tell you what this means, what importance this has in the greater world, but i think it is so beautiful, and maybe that's enough 



feel free to download and test this out project on your local network. just follow the following steps [here](https://github.com/qzpimae/life_socketio/how-to-run)
